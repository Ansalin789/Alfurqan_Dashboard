...
const SignIn: React.FC = () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (role?.includes("SUPERVISOR")) {
          ...
          console.warn("User is not a Supervisor. Ignoring supervisormodules.");
        }
      } else {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!role?.includes("SUPERVISOR")) {
        setLoginError("Only Supervisors are allowed to log in.");
        return;
      }
      ...
      localStorage.setItem("SupervisorPortalEmail", userEmail);
      localStorage.setItem("SupervisorPortalRole", role);
  ...
  const handleGoogleSuccess = async (response: CredentialResponse) => {
    ...
    try {
      ...
      if (result?.message === "Email exists" && role?.includes("SUPERVISOR")) {
        ...
        setLoginError("Access denied: Not a Supervisor");
      }
    } catch (error) {
        ...
        <div className="relative w-full lg:w-1/2 h-screen overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between w-full h-full px-6 lg:px-12 text-center py-6">
              ...
              <div className="flex flex-col md:flex-row items-start gap-4">
                <div className="flex-1 text-left">
                  ...
                  <p className="text-gray-600 mb-4 leading-relaxed text-sm">
                    Monitor team performance, manage recruitment processes, 
                    and oversee teaching operations with comprehensive supervisor tools.
                  </p>
            ...
            <div className="text-center text-white mx-auto">
              <h2 className="text-2xl font-semibold mb-2">Supervisor Dashboard</h2>
              <p className="text-[#CFD9E0] text-sm leading-relaxed max-w-md mx-auto mb-4">
                Access comprehensive supervision tools, team management features, 
                and performance analytics to effectively oversee academic operations.
              </p>
