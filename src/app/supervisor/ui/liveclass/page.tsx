...
function LiveClass() {
  ...
  useEffect(() => {
    ...
    const fetchClassData = async () => {
      try {
        ...
        const response = await axios.get<ClassData>(`http://alfurqanacademy.tech:5001/classShedule/${classScheduleid}`, {
  ...
  useEffect(() => {
    ...
    const handleSubmitfeed = async () => {
      ...
      try {
        const response = await axios.post("http://alfurqanacademy.tech:5001/supervisorfeedback", feedbackData, {
          headers: {
