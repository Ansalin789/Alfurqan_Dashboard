...
// <div className="grid grid-cols-2 lg:grid-cols-2 mb-2 gap-10 w-full">
//   <div className="grid grid-cols-1">
//     <ApplicationChart />
//   </div>
//   <div className="bg-[#FFFFFF] grid grid-cols-1 max-w-full h-[270px] rounded-2xl shadow-md items-center px-3 py-2 gap-1 dark:bg-[#343434] sm:ml-2 flex-shrink-0">
//     {/* Header */}
...
// <div className="bg-white rounded-lg shadow-lg w-full mt-4 overflow-hidden dark:bg-[#343434]">
//   {/* Table wrapper: horizontal scroll */}
//   <div className="overflow-x-auto scrollbar-none h-full">
//     {/* Vertical scroll with fixed height */}
//     <div className="overflow-y-auto h-[410px] scrollbar-none">
//       <table className="min-w-[935px] w-full text-xs border-collapse table-fixed">
//         {/* Table Head sticky */}
//         <thead className="sticky top-0 z-10 text-[12px] bg-[#4C6993] text-white dark:bg-[#6087C0] shadow-md">
//           <tr>
//             {[
//               "Name",
//               "Contact",
...
//             <tr
//               key={applicant._id}
//               className="text-[9px] border-none outline-none hover:bg-gray-100 dark:hover:bg-[#444]"
//             >
...
//           <aside className="w-full hidden lg:block space-y-4 mt-24 mr-2">
//             {/* Calendar Section */}
//             <div className=" p-2 rounded-lg  h-[230px]">
//               <Calendar />
//             </div>
//             {/* Teachers Section */}
// <div className="bg-white  h-[200px] rounded-xl shadow-lg p-3 mt-10 dark:bg-[#343434]">
...
//             {/* Schedule Section */}
//             <div className="bg-white w-full p-4 rounded-lg h-[327px] mb-56 dark:bg-[#343434]">
//               {/* Header */}
//               <div className="flex justify-between items-center mb-3">
//                 <h3 className="text-[16px] font-semibold text-gray-700 dark:text-[#ffff]">
//                   Schedule
//                 </h3>
//                 <button className="px-2 py-1 bg-gray-100 rounded flex items-center gap-1 text-[10px] dark:bg-[#565656]">
//                   Today <span className="text-gray-500">▼</span>
//                 </button>
//               </div>

//               {/* Timeline */}
//               <div className="relative pl-4 space-y-4 h-[230px] overflow-y-auto scrollbar-none">
      ...
      <div className="flex flex-row gap-4 p-0 min-h-screen">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex gap-6">
            <div className="w-[60%] bg-white rounded-xl h-[270px] flex flex-col">
              <div className="flex-1 flex items-center justify-center">
                <ApplicationChart />
              </div>
            </div>
            <div className="w-[40%] bg-white rounded-xl h-[270px] flex flex-col">
            <div className="bg-[#FFFFFF] rounded-xl shadow p-4 h-[270px]">
              {/* Header */}
              <div className="w-full flex justify-between items-center">
                <h3 className="text-[#010E30] text-[13px] font-semibold dark:text-[#ffff]">
                  Subject
            ...
            <div className="overflow-x-auto scrollbar-none h-full">
              ...
              <div className="overflow-y-auto h-[410px] rounded-xl scrollbar-none">
                <table className="min-w-full text-xs border-collapse table-fixed px-4">
                  {/* Table Head sticky */}
                  <thead className="sticky top-0 px-2 z-10 text-[12px] bg-[#4C6993] text-white dark:bg-[#6087C0] shadow-md">
                    <tr>
                      {[
                        "Name",
                        "Contact",
                  ...
                  <tbody>
                    {applicants.map((applicant, index: number) => (
                      <tr
                        key={applicant._id}
                        className={`text-[10px] px-2 py-4 border-none outline-none hover:bg-gray-100 dark:hover:bg-[#444] ${
                          index % 2 === 0
                            ? "bg-[#fff] dark:bg-[#ffffff] "
        ...
        <div className="w-[320px] flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl shadow p-4">
            <div className="font-semibold mb-2">January, 2022</div>
          ...
          {/* Schedule */}
          <div className="bg-white rounded-xl shadow p-4 dark:bg-[#343434] h-[375px]">
            {/* Header */}
            <div className="flex justify-between items-center mb-3">
              <h3 className="text-[16px] font-semibold text-gray-700 dark:text-[#ffff]">
                Schedule
