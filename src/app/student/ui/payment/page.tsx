...
const CheckoutForm: React.FC<CheckoutFormProps> = ({ clientSecret, invoiceId,amount,currency }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (error) {
      ...
      await axios.post('https://api.blackstoneinfomaticstech.com/student/create-payment-intent', {
        amount,
        currency,
        invoiceId,
...
const Invoice = () => {
  ...
  const handleClick = async () => {
    ...
    try {
      const response = await axios.post('https://api.blackstoneinfomaticstech.com/student/create-payment-intent', {
