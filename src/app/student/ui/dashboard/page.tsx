...
// Dynamic imports
const Activity = dynamic(() => import("../../components/Activity/page"), {
  ssr: false,
});
const Totalhours = dynamic(() => import("../../components/Totalhours/page"), {
  ssr: false,
});
const Profile = dynamic(() => import("../../components/Profile/page"), {
  ssr: false,
});
const GeneratePage = dynamic(() => import("../../components/Quotes/page"), {
  ssr: false,
});
const Upcome = dynamic(() => import("../../components/Upcome/page"), {
  ssr: false,
});
const NextEvalu = dynamic(() => import("../../components/NextEvalu/page"), {
  ssr: false,
});
