...
const SignIn: React.FC = () => {
  ...
  const signIn = async (username: string, password: string) => {
    try {
      const response = await axios.post('https://alfurqanacademy.tech/studentsignin', { username, password });
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
   ...
   const checkEmail = async (email: string) => {
    try {
      ...
      const response = await axios.post(`https://alfurqanacademy.tech/check-email`, {email});
