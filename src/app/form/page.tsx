...
//     const loadAvailableTimes = (date: any) => {
...
//     const handleMultiSelectOptionChange = (field: keyof typeof formData, value: string) => {
//         setFormData((prev) => {
//             const currentSelection = prev[field] as string[]; // Type assertion to string[]
...
//     const handleSingleSelectOptionChange = (field: keyof typeof formData, value: string | number) => {
//         setFormData({
//             ...formData,
//             [field]: value,
//         });
