...
const UpcomingTask: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 p-4 rounded-lg shadow-lg -ml-24">
      ...
      <div className="space-y-4">
        {classes.length === 0 ? (
          ...
          classes.map((classItem) => {
            // Extracted border color logic
            let borderColor;
            if (classItem.color === 'blue-500') {
              borderColor = 'border-blue-500';
            } else if (classItem.color === 'red-500') {
            ...
            return (
              <div
                ...
                className={`relative border-l-4 bg-white p-4 rounded-md shadow-md ${borderColor}`}
              >
