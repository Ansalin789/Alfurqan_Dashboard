...
const SchedulePage = () => {
  ...
  useEffect(() => {
    const hardcodedEvents: Event[] = [
      {
        id: "1",
        title: "Math Class",
        start: new Date("2025-04-11T10:00:00"),
        end: new Date("2025-04-11T11:00:00"),
      ...
      },
      {
        id: "2",
        title: "Science Class",
        start: new Date("2025-04-11T13:00:00"),
        end: new Date("2025-04-11T14:00:00"),
      ...
      },
      {
        ...
        description: "Parent-teacher discussion",
        date: "2025-04-12",
      },
    ];
    ...
    setEventsForSelectedDate(
      hardcodedEvents.filter((event) => event.date === today)
    );
  }, []);
