  ...
  return (
    <BaseLayout4>
      <div className="w-full h-screen bg-[#e9e9e9] px-4 py-6 mr-6">
        ...
        <br />
        <div className="flex justify-between items-start  flex-wrap ml-3">
                    ...
                    {openPopup === index && (
                      <div className="fixed inset-0 z-50 flex items-left justify-center bg-black bg-opacity-50">
                        <div className="bg-white w-[55%] md:w-[90%] lg:w-[70%] max-h-[80vh] overflow-y-auto rounded-2xl p-6 relative shadow-lg">
                          ...
                          <h2 className="text-xl font-semibold text-[#1C3557] mb-6 text-left">
                            Edit Payment
                          </h2>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div className="space-y-4">
                              <div>
                                <label
                                  htmlFor="employee Id"
                                  className="block font-medium text-sm text-gray-800 mb-1 text-left"
                                >
                                  Employee ID
                                </label>
                                <input
                                  type="text"
                                  className="w-full h-10 p-4 rounded-xl border border-gray-400 bg-gray-100 text-gray-600 text-sm"
