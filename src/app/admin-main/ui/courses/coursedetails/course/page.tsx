                ...
                {showForm && (
                    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
                        <div className="bg-white rounded-xl p-4 w-[400px] max-h-[100vh] overflow-y-scroll scrollbar-none shadow-xl">
                            <h2 className="text-[15px] font-semibold mb-3">Add Level Form</h2>
                            ...
                            <FormInput label="Level Description" textarea value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} />
