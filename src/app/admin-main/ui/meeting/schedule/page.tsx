  ...
  return (
    <div className="flex justify-between items-center p-2">
      ...
      <div className="flex gap-2">
        <button
          className={`px-3 py-1 text-xs rounded shadow ${view === "month" ? "bg-[#223857] text-white" : "bg-gray-200"
            }`}
        ...
        <button
          className={`px-3 py-1 text-xs rounded shadow ${view === "week" ? "bg-[#223857] text-white" : "bg-gray-200"
            }`}
        ...
        <button
          className={`px-3 py-1 text-xs rounded shadow ${view === "day" ? "bg-[#223857] text-white" : "bg-gray-200"
            }`}
    ...
    const fetchData = () => {
      try {
        ...
        const formattedEvents: Event[] = meetings
          .map((item): Event | null => {
            if (!item.selectedDate || !item.startTime || !item.endTime) return null;
              ...
              <div className="bg-white p-6 w-60 rounded-lg shadow overflow-y-scroll h-[630px] scrollbar-none">
                  ...
                  >
                    {filteredMeetings.length > 0 ? (
                      ...
                      <p className="text-gray-500 text-[12px] text-center">No meetings scheduled for this day.</p>
                    )}
                  </div>
