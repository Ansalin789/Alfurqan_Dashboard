...
const StudentModuleAccess = () => {
  ...
  const handleSubmit = async () => {
    ...
    const studentmodules: { [key: string]: boolean } = {};
    ...
    modules.forEach((module) => {
      ...
      studentmodules[key] = selectedModules[module] || false;  // Get value from selectedModules
    });
  
    // Debugging: Log the adminmodules to see the final structure
    console.log('Adminmodules before submit:', studentmodules);
