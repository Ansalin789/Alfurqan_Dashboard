...
const StudentModuleAccess = () => {
  ...
  return (
    <BaseLayout4>
          <AdminHeader currentSection=" Student Module Access" />
      ...
      <tr>
      <th  className="p-3 text-[13px] text-left flex ml-1 flex-row gap-3 "><FaRegMinusSquare className='rounded mt-1 text-[13px]'/>Modules</th>
