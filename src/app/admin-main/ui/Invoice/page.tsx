      ...
      <AdminHeader currentSection="Invoice" />
        <div className="p-6 w-full mx-auto">
              ...
              <div className="flex justify-between items-center px-4 py-0 rounded-md dark:bg-[#343434]">
                ...
                <div className="flex items-center gap-2 text-[14px] text-gray-400 dark:text-gray-400">
                  <span className="text-left -ml-60">
                    Showing {filterAndSearchInvoices.length} of{" "}
                    {filterAndSearchInvoices.length}
                  </span>
                </div>
              </div>
          ...
          <div className="flex justify-end">
            <button
              className="mt-2 text-[#576CBC] border border-[#576CBC] bg-[#fff] rounded px-2 py-1 text-xs font-medium hover:bg-[#dbe2f3] transition duration-200 dark:bg-[#2E3343]"
