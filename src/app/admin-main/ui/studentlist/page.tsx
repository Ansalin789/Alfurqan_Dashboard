          ...
          return (
            ...
            >
              ...
              <div className="w-1/4 flex flex-col items-center border-r pr-4 ">
                ...
                <h3 className="mt-1 text-sm font-semibold text-center">{student.name}</h3>
                ...
                <div className="flex mt-1">
                  {[...Array(5)].map((_, i) => (
                    <FaStar
                      key={i}
                      className={i < student.rating ? "text-yellow-500 text-xs" : "text-gray-300 text-xs"}
                    />
                  ))}
                </div>
              ...
              <div className="w-3/4 pl-4 ">
                  ...
                  <div className="grid grid-cols-3 gap-x-7 gap-y-1 text-xs">
                    ...
                    <div className="mt-2">
                      ...
                      <p className="font-semibold text-blue-600 truncate">{student.email}</p>
                    </div>
                    <div className="mt-2">
