...
const StudentsRecord = () => {
  return (
     <div className="flex flex-col lg:flex-row gap-11 min-w-[800px]  h-[250px]">
                 {/* Teachers Records */}
                 <div className="bg-white p-5 rounded-2xl shadow-md border border-gray-200 w-full lg:min-w-[450px] lg:max-w-[580px] h-[250px]">
                   <h2 className="text-[16px] font-semibold text-gray-800 mb-4">Student Record</h2>
                   <div className="flex items-center">
                     <div className="space-y-6 text-xs mb-7">
                 ...
                 {/* Gender Chart */}
                 <div className="bg-white p-5 rounded-2xl shadow-md border border-gray-200 w-full sm:w-[280px] h-[250px] flex flex-col items-center relative">
                 ...
                 {/* Countries Block */}
                 <div className="bg-white p-5 rounded-2xl shadow-md border border-gray-200 w-full sm:w-[275px] h-[250px] space-y-4">
