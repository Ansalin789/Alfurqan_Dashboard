    ...
    <div className="flex flex-col lg:flex-row w-full gap-4 sm:gap-4 md:gap-3 lg:gap-4 xl:gap-4 w-full">
      ...
      <div className="bg-[#F7FBFF] mx-auto dark:bg-[#343434] p-5 rounded-2xl shadow-md w-full sm:max-w-[370px] md:max-w-[450px] lg:max-w-[620px] h-[250px]">
        ...
        <div className="flex items-start justify-between gap-8">
          {/* Legend Section */}
          <div className="space-y-5 text-[13px] mt-1 text-[#0B0F19] dark:text-white">
      ...
      {/* Gender Chart */}
      <div className="bg-[#F7FBFF] mx-auto dark:bg-[#343434] p-5 rounded-2xl shadow-md w-full sm:max-w-[262px] md:max-w-[230px] h-[250px] flex flex-col items-center justify-between relative">
      ...
      {/* Countries Block */}
      <div className="bg-[#F7FBFF] dark:bg-[#343434] mx-auto p-5 rounded-2xl shadow-md w-full sm:max-w-[312px] md:max-w-[230px] h-[250px] flex flex-col">
